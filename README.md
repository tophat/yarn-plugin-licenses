...
module.exports = {
    isValidLicense: new RegExp('\\b(mit|apache\\b.*2|bsd|isc|unlicense)\\b', 'i'),
    // To apply a different matching rule to dev dependencies, use the isValidDevLicense property
    isValidDevLicense: new RegExp('\\b(mit|apache\\b.*2|bsd|isc|unlicense|CC(0|-BY)-[\d.]+|LGPL-[\d.+]+)\\b', 'i'),
}
```
